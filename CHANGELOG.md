...
- Upgrade to clasp v3.x and modernize build tooling by @k2tzumi in https://github.com/k2tzumi/mob-timer-bot/pull/41
- fix(ci): discard local changes before branch checkout in tagpr by @k2tzumi in https://github.com/k2tzumi/mob-timer-bot/pull/42
